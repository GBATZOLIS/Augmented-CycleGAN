...
class TrainOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--eval_A_freq', type=int, default=10, help='frequency of evaluating on A')
        self.parser.add_argument('--eval_B_freq', type=int, default=100, help='frequency of evaluating on B')
